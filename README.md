...
Numer stoi w jednym miejscu: `WERSJA` w [`engine/palantir.mjs`](engine/palantir.mjs) (dziś **1.8**,
81 reguł). Idzie co 0,1 i podbija się **zawsze, gdy czyjś wynik może się przesunąć**: nowa albo
